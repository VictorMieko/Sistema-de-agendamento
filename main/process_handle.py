...
from main.constructor.list_appointment_constructor import list_appointment_constructor
...
def start() -> None:
    while True:
        ...
        elif command == "4": list_appointment_constructor(appointment_repository)
        elif command == "0": exit()
